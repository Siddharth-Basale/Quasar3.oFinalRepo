...
# Constants
FACE_LANDMARKS = [4, 152, 263, 33, 287, 57]  # Indices for nose tip, chin, eyes, and mouth
EYE_LANDMARKS = [468, 473]  # Indices for left and right pupil
...
def gaze(frame, points):
    ...
    # Camera matrix (constant for a given camera)
    ...
    # Transform pupil position to 3D world coordinates
